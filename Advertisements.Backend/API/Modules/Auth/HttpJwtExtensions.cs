...
public static class HttpJwtCookieExtensions
{
    ...
    public static JwtPayload? GetTokenDtoOrDefault(this HttpRequest httpRequest)
    {
    ...
    public static void AttachJwtCookies(this HttpResponse httpResponse, JwtPayload dto)
    {
