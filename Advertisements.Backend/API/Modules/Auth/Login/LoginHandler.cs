...
public class LoginHandler : IRequestHandler<LoginCommand, JwtPayload>
{
    ...
    public async Task<JwtPayload> Handle(LoginCommand request, CancellationToken cancellationToken)
    {
