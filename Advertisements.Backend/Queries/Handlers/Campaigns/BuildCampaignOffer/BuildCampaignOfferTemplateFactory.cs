...
public class BuildCampaignOfferTemplateFactory
{
    ...
    public string InjectDemoCompanyRepresentative(string html)
    {
        var tableRows = new[]
        {
            BuildRepresentativeRow("Pasiūlymą parengė", "Vardenis Pavardenis"),
            BuildRepresentativeRow("Pareigos", "Pardavimų atstovas"),
            BuildRepresentativeRow("Telefonas", "varpav@reklamosarka.lt"),
            BuildRepresentativeRow("El. paštas", "+37052396060"),
        };
    ...
    public string InjectTableRows(string html, CampaignWithPriceDetails campaign)
    {
        ...
        var planeRow = rowTemplate
            ...
            .Replace("{{DiscountPercent}}", campaign.DiscountPercent.ToString())
        ...
        var rowsHtml = planeRow + pressRow + planeRow;
    ...
    {
        var template = """<table className="border-collapse border border-black">"""
                       + """<tbody>"""
            ...
            <html lang="lt">
                ...
                <body>
                    <div class="m-12">
                        ...
                        <div class="mt-6 mb-2 w-full text-xl text-center font-bold">
                        ...
                        <div class="flex justify-center">
                            <table class="border-collapse">
                                ...
                                <tr class="w-full text-center">
                                    <td
                                            class="border border-black px-2 text-center"
                                            colSpan="100%"
                                    >
                                ...
                                <tr>
                                    <th class="border border-black px-2 text-center">
                                        Produktas
                                    </th>
                                    <th class="border border-black px-2 text-center">
                                        Kiekis<sup>1</sup>
                                ...
                                <tr>
                                    ...
                                    <td
                                            colSpan=2
                                            class="border border-black px-2 text-center font-bold"
                                    >
                                        Bendra Suma
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan=6>
                                        <sup class="ml-2">1</sup> Užsakomos plokštumos
                                        detalizuojamos priede nr. 1 po sąmatos patvirtinimo
                                    </td>
                                    <td class="border border-black px-2 text-center font-bold">
                                        Suma be PVM
                                    </td>
                        ...
                        <div class="mt-16 flex justify-between items-end mb-12">
                            <div class="mb-16">
                                {{CompanyRepresentativeTable}}
                            </div>
                            <div style="width:300px">
                                <hr class="solid mb-2 border-black" style="color:gray">
